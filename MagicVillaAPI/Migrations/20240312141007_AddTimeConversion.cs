...
{
    public partial class AddTimeConversion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2024, 3, 12, 15, 10, 7, 292, DateTimeKind.Utc).AddTicks(3790), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "CreatedDate", "UpdatedDate" },
                values: new object[] { new DateTime(2024, 3, 12, 15, 10, 7, 292, DateTimeKind.Utc).AddTicks(3816), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
        }
